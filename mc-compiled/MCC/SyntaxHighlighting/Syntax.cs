...
internal static class Syntax
{
        ...
        keywords = new[]
            {
                ...
                new Keyword("bool",
                    "A true or false value. Displayed as whatever is set in the '_true' and '_false' preprocessor variables respectively."),
                ...
                new Keyword("ppv",
                    "A preprocessor variable that will be set on function call. Not currently supported as a variable/struct type.")
            }
            .Concat(
    ...
    public static readonly Keywords options = new()
    {
        ...
        [
            ...
            new Keyword("forward",
                "Used with the 'move' command. Goes forward relative to where the entity is looking."),
            new Keyword("backward",
                "Used with the 'move' command. Goes backward relative to where the entity is looking."),
            ...
            new Keyword("removeall",
                "Used with the 'dummy' command. Subcommand, removes all dummies, optionally with the given tag."),
            ...
            new Keyword("hollow",
                "Hollow the area, only filling the outer edges with the block. To keep inside contents, use 'outline'."),
            new Keyword("outline",
                "Outline the area, only filling the outer edges with the block. To remove inside contents, use 'hollow'."),
            ...
            new Keyword("change",
                "Change the dialogue that shows up when an NPC is interacted with (for specific players if specified)"),
            ...
            new Keyword("page:",
                "If this item is a 'written_book', add a page to it.  Multiple of these can be used to add more pages."),
    ...
    private static Keyword[] KeywordsFromDirectives(IEnumerable<Directive> directives)
    {

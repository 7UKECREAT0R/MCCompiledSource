...
namespace mc_compiled.MCC
{
    ...
    public class StructDefinition
    {
        ...
        /// <returns></returns>
        public ScoreboardValueStruct Create(string name, bool global, ScoreboardManager manager, Compiler.Statement forExceptions) =>
            new ScoreboardValueStruct(name, global, this, manager, forExceptions);

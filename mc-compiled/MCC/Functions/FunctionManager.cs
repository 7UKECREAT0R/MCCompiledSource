...
public class FunctionManager
{
    ...
    /// </summary>
    private readonly Dictionary<string, List<Function>> functionRegistry;
    ...
    internal void RegisterDefaultProviders()
    {
        ...
        {
            IEnumerable<Function> functions = provider.ProvideFunctions(this.scoreboardManager);
    ...
    {
        return from funcList in this.functionRegistry.Values

...
/// <summary>
///     A runtime function parameter that can accept any type that falls under a filter. The parameter's current value will
///     be held in the `RuntimeDestination` property.
/// </summary>
internal class RuntimeFunctionParameterDynamic : RuntimeFunctionParameter
{
    ...
    /// <summary>
    ///     A runtime function parameter that can accept any type. The parameter's current value will be held in the
    ///     `RuntimeDestination` property.
    /// </summary>
    public RuntimeFunctionParameterDynamic(GenerativeFunction parent, string aliasName, string name,
        Token defaultValue = null) : base(name, defaultValue)
    {
        this.parent = parent;
            ...
            case TokenLiteral literal:
            {
                ...
                if (type == null)
                    throw new StatementException(callingStatement,
                        "Invalid parameter input (literal). Developers: please use CheckInput(...)");

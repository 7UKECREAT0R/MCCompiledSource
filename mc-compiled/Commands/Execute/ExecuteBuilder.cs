...
public class ExecuteBuilder
{
    ...
    {
        IEnumerable<string> parts = this.subcommands.Select(subcommand => subcommand.ToMinecraft());
    ...
    {
        this.subcommands.Add(new SubcommandFacing(true, entity, anchor, Coordinate.zero, Coordinate.zero,
            Coordinate.zero));
        return this;
    }
    /// <summary>
    ...
    /// <summary>
    ///     Run a command with all the previous subcommands applied. Calls <see cref="Build" /> and returns it, as 'run' is
    ///     terminating.
    /// </summary>

    ...
    int? volumeZ = null)
{
    ...
    {
        return Nullable.Equals(this.x, other.x) && Nullable.Equals(this.y, other.y) &&
               Nullable.Equals(this.z, other.z) &&
               Nullable.Equals(this.radiusMin, other.radiusMin) && Nullable.Equals(this.radiusMax, other.radiusMax) &&
               this.volumeX == other.volumeX && this.volumeY == other.volumeY && this.volumeZ == other.volumeZ;
    }

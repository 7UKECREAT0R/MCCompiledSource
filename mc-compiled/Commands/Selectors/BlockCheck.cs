...
{
    public static readonly BlockCheck DISABLED = new() {present = false};
    /// <summary>
    ...
    {
        return
            $"execute {selector} ~~~ detect {this.x} {this.y} {this.z} {this.block} {this.data ?? 0} scoreboard players set @s {objective} 1";
    }
    ...
    public override bool Equals(object obj)
    {
        return obj is BlockCheck check && this.present == check.present &&
               ...
               EqualityComparer<Coordinate>.Default.Equals(this.z, check.z) && this.block == check.block &&

...
public class Manifest : IAddonFile
{
    ...
    {
        return this.type == ManifestType.BP ? OutputLocation.b_ROOT : OutputLocation.r_ROOT;
    }
    /// <summary>
    ...
    public static Manifest Parse(JObject json, ManifestType type, string projectName)
    {
        ...
        if (json.TryGetValue("dependencies", out JToken dependenciesToken) &&
            dependenciesToken.Type == JTokenType.Array)
        {

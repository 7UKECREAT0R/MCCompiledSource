...
public class ManifestVersion
{
    ...
    /// <param name="result">
    ///     When this method returns, contains the parsed VersionArray if successful, or null if failed to
    ///     parse.
    /// </param>
    ...
    /// <param name="output">
    ///     When this method returns, contains the parsed ManifestVersion if the parsing was successful, or
    ...
    /// <summary>
    ///     Tries to parse a string representation of a manifest version and returns a value indicating whether the parsing was
    ///     successful.
    /// </summary>
    /// <param name="input">The string representation of a manifest version.</param>
    /// <param name="output">
    ///     When this method returns, contains the parsed ManifestVersion object if the parsing was
    ///     successful, or null if the parsing failed.
    /// </param>
    /// <returns>true if the parsing was successful; otherwise, false.</returns>
    ...
    /// <param name="output">
    ///     When this method returns, contains the parsed ManifestVersion if successful, or null if failed to
    ///     parse.
    /// </param>
    /// <returns>true if the parsing was successful; otherwise, false.</returns>
    ...
    /// <summary>
    ///     Converts this ManifestVersion to a string representing it as a semantic version separated by periods. e.g.,
    ///     "1.10.0"
    /// </summary>
    /// <returns></returns>

...
namespace mc_compiled.Modding.Manifest
{
    ...
    public abstract class Module
    {
        ...
        /// <param name="module">When this method returns, contains the parsed Module object if the parsing was successful, or null if the parsing failed.</param>
        /// <returns>
            ...
            switch (type)
            {
                ...
                case ModuleType.script:
                    ...
                    else
                    {
                        ...
                        Executor.Warn($"No entry point specified in 'script' module. Defaulting to '{DEFAULT_ENTRY_POINT}'.");

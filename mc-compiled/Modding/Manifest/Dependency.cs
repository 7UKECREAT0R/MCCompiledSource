...
namespace mc_compiled.Modding.Manifest
{
    ...
    public abstract class Dependency
    {
        ...
        /// <param name="dependency">When this method returns, contains the parsed Dependency object if the parsing was successful, or null if the parsing failed.</param>
        /// <returns>

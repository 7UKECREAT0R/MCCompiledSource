...
public struct EntityNBT
{
    ...
    public EntityNBT(short age = 200, short air = 300, short attackTime = 0, bool chested = false, float bodyRot = 0f,
        int breedCooldown = 0,
        string customName = null, bool customNameVisible = true, bool dead = false, short deathTime = 0,
        short hurtTime = 0, int inLove = 0,
        byte color = 0, byte color2 = 0, float fallDistance = 0, short fire = 0,
        short health = 20, bool invulnerable = false, bool isAngry = false, bool isAutonomous = false,
        bool isBaby = false, bool isEating = false,
        bool isGliding = false, bool isGlobal = false, bool isIllagerCaptain = false, bool isOrphaned = false,
        bool isOutOfControl = false,
        bool isRoaring = false, bool isScared = false, bool isStunned = false, bool isSwimming = false,
        bool isTamed = false, bool isTrusting = false,
        ItemNBT? item = null, int lastDimensionID = 0, bool lootDropped = false, int markVariant = 0,
        VectorNBT motion = default, bool onGround = true,
        long ownerID = -1, long ownerNew = -1, int portalCooldown = 0, VectorNBT pos = default,
        RotationNBT rotation = default, bool saddled = false,
        bool sheared = false, bool showBottom = false, bool sitting = false, int skinID = 0, int strength = 0,
        int strengthMax = 0, byte[] tags = null,
        long uniqueID = 123456, int variant = 0, string[] definitions = null,
        string identifier = "minecraft:armor_stand")
    {
